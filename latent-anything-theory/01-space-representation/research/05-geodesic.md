...
> **TL;DR.** Trên đa tạp cong, đường ngắn nhất giữa hai điểm là **geodesic**, không phải đường thẳng trong ambient space. Hệ quả: nội suy tuyến tính (lerp) đi xuyên ra ngoài đa tạp → cần exp/log map, [pullback metric](06-pullback-metric.md), hoặc làm phẳng không gian ([FlatVI](07-flatvi.md)).
...
Trong không gian bao quanh (ambient space - thường là Euclidean), khoảng cách ngắn nhất giữa hai điểm luôn là một đường thẳng. Tuy nhiên, các đa tạp lại là các cấu trúc hình học phi tuyến bị uốn cong, do đó một đường thẳng thông thường nối hai điểm trên đa tạp sẽ đâm xuyên khỏi bề mặt của nó.
...
![Geodesic Interpolation](../assets/geosedic-interpolation.png)
...
![MNIST Geodesic](../assets/mnist-geosedic.png)
