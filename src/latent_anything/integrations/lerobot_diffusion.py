...
from latent_anything.integrations._lerobot_diffusion_analysis import (
    DiffusionAnalysisResult as DiffusionAnalysisResult,
)
from latent_anything.integrations._lerobot_diffusion_analysis import (
    analyze_traces,
)
...
DiffusionAnalysisResult.__module__ = __name__
    ...
    def select_action(
        ...
        *,
        ...
        def hook(
            ...
            """Capture one denoiser output and its global conditioning tensor."""
            nonlocal call_index
            del module
