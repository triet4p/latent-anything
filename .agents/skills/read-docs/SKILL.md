...
1. Read [INDEX](../../../docs/INDEX.md) to understand what documents exist and what they cover.
2. Read [LANGUAGE](../../../docs/LANGUAGE.md) to understand which language to use in each context.
3. Locate your target document in [INDEX](../../../docs/INDEX.md) and read it. To understand the project fully, read all documents in the order listed in [INDEX](../../../docs/INDEX.md). There are three cases:
