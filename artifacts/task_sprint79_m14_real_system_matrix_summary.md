...
Lane receipts use `source_sha` as the exact checkout HEAD used for their command. Accepted L11/L14/L15/L16 execution receipts and runners were measured at `520ba3b6ec2143c9ffb766eab14335e1e35444b9`; accepted L22 runtime and L06 diagnosis/failure evidence plus source correction were measured at `d6fb1d19a60dd64c2ae0c743c6d390d6666d96eb`; prior accepted lane source SHAs remain recorded in their immutable receipts.
...
| L06 | Pending | `env LATENT_ANYTHING_RUN_NETWORK=1 uv run --locked --extra transformers --with huggingface-hub==0.35.3 python scripts/m14_l06_sae.py` — expanded real GPT-2 layer-6 capture **n_tokens=10752**, n_components `4`, dead features `0`, reconstruction MSE `0.7104635182257194`; cross-seed mean/min cosine `0.8467253367037664/0.7387987235614891` and alignment `0.75` remain below predeclared `0.85/0.7` gates (min cosine fails). Fixed-split source correction removed split confounding; focused test **1 passed, 21 deselected, 1 warning in 23.41s**; the 234-token baseline failure remains recorded. | [`l06-sae.json`](m14/l06-sae.json) and [`l06-sae-run.json`](m14/l06-sae-run.json), run SHA-256 `1ffa688ba5aece4b3cd400b4d9db606df8af1a39a0de3757d35d6b6a61d44234`; atlas SHA-256 `868307f44f5bd9312546bc0df28c6f3fd00a11a9f57b8554ad7bf18d20f68e7d`; pinned GPT-2 weights SHA-256 `248dfc3911869ec493c76e65bf2fcf7f615828b0254c12b473182f0f81d3a707`. |
...
l06-sae.json                bf9332bbdff1514e2368844f34ba2ffb5a88ac3e2b479448a09dfe769973c3b5
...
l11-gpt2.json               b4e24236637a5e4a515972a7fbf64fa2a7b22cf61a8e1b89751f99f12ce0ca46
