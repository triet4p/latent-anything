...
| L04 | **Partial; DirectLogitLens support-only completed additively.** Capability receipt `artifacts/m14/l04-explanations.json` retains immutable accepted TunedLogitLens D3 and Disentanglement D2 records. IntegratedGradients and TCAV support-only executions remain failed against frozen semantic gates. The current-checkpoint DirectLogitLens run used exact source SHA `5ea5b9566dcf7631232c2f9a4ed667d6586975de`, pinned GPT-2, and `TransformerLMIntegration`; parity absolute/relative medians were `0.0` with held-out selectivity `0.0009173363650916144` (95% CI `[0.0005931574705755338, 0.0012898929126095027]`). It passed all support-only controls and remains D0/non-promoting. |
...
- Exactly three L04 use cases have now been run additively: IntegratedGradients, TCAV, and DirectLogitLens. The DirectLogitLens run used native PowerShell `ssh.exe` transport at pushed SHA `5ea5b9566dcf7631232c2f9a4ed667d6586975de`; SSH/use-case/bundle/final exits were `0`, transport and remote cleanup passed, and raw capture SHA-256 `265a99c8bbd28d0d08aee506cde5501dabc4e524ffa7aab34cc34925fd0dff3f` was verified before finalize-delete. Its sanitized audit and attempt-2 triad validators returned zero errors; support-only D0 status remains non-promoting.
...
l04-explanations.json       62ba7eff74db65e559b670decc6a42af70c363b3099fedc13cfce5464ca6224c
