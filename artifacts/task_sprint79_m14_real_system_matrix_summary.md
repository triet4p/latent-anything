...
| L08 | Pending | Combined local verification with L13/L16 — **51 passed in 7.30s** (including `test_conv_vae_heldout_benchmark.py`). | [`l08-convvae.json`](m14/l08-convvae.json). Standalone held-out D2 metrics/artifact, including the declared >=10% zero-baseline gate, are absent. |
...
| L13 | Pending | Combined local verification with L08/L16 — **51 passed in 7.30s** (including `test_vq_vae_benchmark.py`). | [`l13-vq.json`](m14/l13-vq.json). Required standalone perplexity/dead-code/finite encode-decode artifact and codebook-cleanup evidence remain absent. |
...
l08-convvae.json            d80f806b17693ed5488a6a5890fe959e351b6fc0f5a8ad459d48173274087ad8
...
l13-vq.json                 1baa9fb3428d4095de41a35cd202ea5f4b00c2f47c44f5ed0ab1501a28e4d639
...
l16-planning.json           278d8b6db447bd6e9b3b3a784ceecf5314b20ea6db8b7921d006910d1956dc0d
...
l19-act.json                9bf5867f01548e61de544aa01d0ca646e08287441316e72be459519eafeff6bf6
