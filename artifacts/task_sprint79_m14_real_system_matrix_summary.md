...
Lane receipts use `source_sha` as the exact checkout HEAD used for their command. The code-content baseline is unchanged across filing-only commits: L04/L07/L10/L12/L14/L15/L17-L22/L24 receipts executed at `fdd769f842d6fb228270c662db39b261a62bdf40`; L06/L11/L23 executed at `4a159bd9bae0d044109e35b16bbd060160c436fa`; L05/L08/L13/L16 executed at `e8e65b96d7b2d67e7468b2c33bf04fd13e160e7d`; L09 measured rerun executed at `99a5d1be401014fac5508d6fb6bbcb3c502332c7`. These later revisions changed only evidence/docs filing plus reproducibility runners, not existing lane implementations. The final filing commit is reported at handoff.

- **Completed/accepted:** 6/24 (L01, L03, L08, L09, L13, L23).
- **Pending/observed:** 8/24 (L05, L06, L07, L11, L14, L15, L16, L22).
...
| L06 | Observed/pending | `env LATENT_ANYTHING_RUN_NETWORK=1 uv run pytest tests/test_sae_evaluation.py tests/test_sae_evaluation_network.py -m network -q` — **1 passed, 21 deselected, 1 warning in 23.85s** on real pinned GPT-2; atlas/cross-seed checks passed. | [`l06-sae.json`](m14/l06-sae.json). D3 gap remains; no promotion. |
...
| L09 | Accepted | `env LATENT_ANYTHING_RUN_NETWORK=1 uv run pytest tests/test_diffusers_vae.py tests/test_diffusers_vae_network.py -m network -q` — **1 passed, 5 deselected, 1 warning in 14.75s**; `env LATENT_ANYTHING_RUN_NETWORK=1 uv run --locked --extra diffusers --with huggingface-hub==0.35.3 python scripts/m14_l09_diffusers_vae.py` passed real parity (max error `0.0`), seeded sampling, and finite shape/dtype checks. | [`l09-diffusers-vae.json`](m14/l09-diffusers-vae.json). Model `stabilityai/sd-vae-ft-mse@31f26fdeee1355a5c34592e401dd41e45d25a493`; weights SHA-256 `a1d993488569e928462932c8c38a0760b874d166399b14414135bd9c42df5815`, MIT; CPU/Windows-11-10.0.26200-SP0; Python 3.13.3; NumPy 2.4.6; Torch 2.10.0; Diffusers 0.39.0; huggingface-hub 0.35.3; RSS peak 921952256 bytes; input seed 7, sample seeds 123/123/124; final rerun HF-cache-only network policy. |
...
l06-sae.json                4cb89dc171782e64d980ab779e0ada1a5b1f8bcf988f66408aaf2fc40e26f761
l07-interventions.json      82d399a33ef359b24003e0518298e384fdf1c3c70a57489469882fc34a753afc
l08-convvae.json            b03d419389ed7b3f765a2ee0deed5299f4d7a7411d3caf8e6b4e94250a6e0671
l09-diffusers-vae.json      ad4052de9c1a0360557ad834d39e6581d91278f0f2bc2bd8aaa62a8388849ace
